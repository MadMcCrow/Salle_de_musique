...
/*
 box{ <0,0,0>, <1200, 500, 1200>
      ...
      interior{
        media{
          scattering { 2, 0.1 extinction 0.01 }
          samples 10, 50
        } // end media 
      } // end interior
 }
...
// (---focal blur extras---)
 ...
 focal_point <1000,10,1000>         // point that is in focus <X,Y,Z>
...
#declare G_table_1 = union{
                            ...
                            object { midi_keyboard          scale 1             rotate <0,10*rand(Random_1),0>     translate <0,72,30>    }
                            object { Enceinte_table         scale 1.2           rotate <0,180+10*rand(Random_1),0> translate <90,71,40>   }
...
#declare G_table_2 = union{
                            ...
                            object { midi_keyboard          scale 1             rotate <0,10*rand(Random_2),0>     translate <0,72,30>    }
                            object { Enceinte_table         scale 1.2           rotate <0,180+10*rand(Random_2),0> translate <90,71,40>   }
...
#declare G_table_3 = union{
                            ...
                            object { midi_keyboard          scale 1             rotate <0,10*rand(Random_3),0>     translate <0,72,30>    }
                            object { Enceinte_table         scale 1.2           rotate <0,180+10*rand(Random_3),0> translate <90,71,40>   }
...
#declare G_table_4 = union{
                            ...
                            object { midi_keyboard          scale 1             rotate <0,10*rand(Random_4),0>     translate <0,72,30>    }
