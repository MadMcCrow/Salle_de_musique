...
#declare Room_basebox_box  = object {box { <0,-1,0>          , < R_width,  R_height+1, R_depth_1>          }    texture {T_Mur}     }
...
#declare Room_exterior_box = object { Room_interior_box scale 1.2 translate < -R_width*0.1, -R_height*0.1,-R_depth_1*0.1 > }                                   
...
camera { perspective location <10,10,10>   right     x*image_width/image_height look_at <500,0,500> angle 60 }  
...
light_source {<500,390,500>  color White }
